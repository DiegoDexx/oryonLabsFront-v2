...
const HEADERS = ['Nº Factura', 'Cliente', 'Tipo', 'Importe', 'Vencimiento', 'Estado', 'Acción'];
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-100">
              {invoices.length === 0 ? (
                <tr><td colSpan={HEADERS.length} className="px-6 py-12 text-center text-gray-500">Sin facturas</td></tr>
              ) : invoices.map(inv => (
